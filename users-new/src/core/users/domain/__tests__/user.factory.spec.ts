...
describe("UserFactory Unit Tests", () => {
  ...
  describe("One fake user", () => {
    it("Should create a fake user", () => {
    ...
    it("Should create a fake user with provided id", () => {
      const id = new Uuid();
      const faker = UserFactory.fake().one();
    ...
    it("Should create a fake user with provided name", () => {
    ...
    it("Should create a fake user with provided email", () => {
    ...
    it("Should create a fake user with provided status", () => {
      const faker = UserFactory.fake().one();
    ...
    it("Should create a fake user with provided createdAt", () => {
  ...
  describe("Many fake users", () => {
    it("Should create many fake users", () => {
    ...
    it("Should create many fake users with provided id", () => {
      const id = new Uuid();
      const faker = UserFactory.fake().many(5);
    ...
    it("Should create many fake users with provided name", () => {
      const name = chance.name();
    ...
    it("Should create many fake users with provided email", () => {
      const email = new Email(chance.email());
      const faker = UserFactory.fake().many(5);
    ...
    it("Should create many fake users with provided status", () => {
      const faker = UserFactory.fake().many(5);
    ...
    it("Should create many fake users with provided createdAt", () => {
      const createdAt = new Date();
      const faker = UserFactory.fake().many(5);
